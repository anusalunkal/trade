...
var GotoDefinition = /** @class */ (function (_super) {
    ...
    function GotoDefinition(props) {
        ...
        _this.openIndex = function (index) {
            var def = _this.props.data.definitions[index];
        ...
        return (React.createElement(Modal, { isOpen: true, onRequestClose: this.props.unmount },
            React.createElement("div", { style: csx.extend(csx.vertical, csx.flex) },
                React.createElement("div", { style: csx.extend(csx.horizontal, csx.content) },
                    React.createElement("h4", null, "Multiple Definitions Found"),
...
var GotoDefinitionAction = /** @class */ (function (_super) {
    ...
    GotoDefinitionAction.prototype.run = function (accessor, editor) {
        ...
        socketClient_1.server.getDefinitionsAtPosition({ filePath: filePath, position: position }).then(function (res) {
            if (res.definitions.length == 0) {
                ...
                ReactDOM.render(React.createElement(GotoDefinition, { data: res, unmount: unmount }), node);
            }
        });
    };
